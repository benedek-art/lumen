...
enum SliderInventory {
    ...
    static let all: [SliderSpec] = [
        ...
        SliderSpec("Contrast", "LookPanel.swift:1167", .developTop, 0.1...10,
                   step: 0.05, decimals: 2),
        SliderSpec("Skew", "LookPanel.swift:1185", .developTop, -1...1,
                   step: 0.01, decimals: 2),
        SliderSpec("Hue keep", "LookPanel.swift:1194", .developTop, 0...100, step: 1),
        SliderSpec("Black target", "LookPanel.swift:1203", .developTop, 0...9,
                   hard: 0...9, step: 0.01, decimals: 2),
        SliderSpec("Strength", "LookPanel.swift:1327", .developTop, 0...100, step: 1),
        SliderSpec("Film Exposure", "LookPanel.swift:1334", .developTop, -2...3,
                   step: 0.25, decimals: 2),
        SliderSpec("Push / Pull", "LookPanel.swift:1339", .developTop, -1...2,
                   step: 0.25, decimals: 2),
        SliderSpec("Halation", "LookPanel.swift:1349", .developTop, 0...100, step: 1),
        SliderSpec("Halo Size", "LookPanel.swift:1365", .developTop, 0.5...2.0,
                   step: 0.05, decimals: 2, indented: true),
        SliderSpec("Halo Redness", "LookPanel.swift:1382", .developTop, 0...100,
                   step: 1, indented: true),
        SliderSpec("Grain", "LookPanel.swift:1407", .developTop, 0...100, step: 1),
        SliderSpec("Grain size", "LookPanel.swift:1414", .developTop, 0.5...2.0,
                   step: 0.05, decimals: 2),

...
enum SliderInventory {
    ...
    static let all: [SliderSpec] = [
        ...
        SliderSpec("Highlights", "CurveEditorView.swift:526", .developTop, -100...100, step: 1),
        SliderSpec("Lights", "CurveEditorView.swift:531", .developTop, -100...100, step: 1),
        SliderSpec("Darks", "CurveEditorView.swift:535", .developTop, -100...100, step: 1),
        SliderSpec("Shadows", "CurveEditorView.swift:539", .developTop, -100...100, step: 1),
        ...
        SliderSpec("Luminance", "DetailPanel.swift:535", .developDisclosure, 0...100, step: 1),
        SliderSpec("Detail", "DetailPanel.swift:585", .developDisclosure, 0...100,
                   step: 1, indented: true),
        SliderSpec("Contrast", "DetailPanel.swift:594", .developDisclosure, 0...100,
                   step: 1, indented: true),
        SliderSpec("Colour", "DetailPanel.swift:603", .developDisclosure, 0...100, step: 1),
        SliderSpec("Detail", "DetailPanel.swift:624", .developDisclosure, 0...100,
                   step: 1, indented: true),
        SliderSpec("Smoothness", "DetailPanel.swift:634", .developDisclosure, 0...100,
                   step: 1, indented: true),
        SliderSpec("Hot Pixels", "DetailPanel.swift:644", .developDisclosure, 0...100, step: 1),
        SliderSpec("Amount", "DetailPanel.swift:671", .developDisclosure, 0...100, step: 1),
        ...
        SliderSpec("Quality", "ExportSheet.swift:517", .exportSheet, 0...100, step: 1),
        SliderSpec("Megapixels", "ExportSheet.swift:662", .exportSheet, 0.5...100,
                   hard: 0.1...500, step: 0.5, decimals: 1),
        SliderSpec("Pixels", "ExportSheet.swift:666", .exportSheet, 320...8000,
                   hard: 16...30000, step: 8),
        SliderSpec("Resolution", "ExportSheet.swift:674", .exportSheet, 72...600,
                   hard: 1...2400, step: 1),
        SliderSpec("Opacity", "ExportSheet.swift:853", .exportSheet, 0...100, step: 1),
        SliderSpec("Size", "ExportSheet.swift:856", .exportSheet, 0.5...20,
                   step: 0.1, decimals: 1),
        SliderSpec("Inset", "ExportSheet.swift:859", .exportSheet, 0...20,
                   step: 0.1, decimals: 1),
        SliderSpec("Headroom", "ExportSheet.swift:901", .exportSheet, 0.5...4,
                   step: 0.1, decimals: 1),
        ...
        SliderSpec("Contrast", "LookPanel.swift:1173", .developTop, 0.1...10,
                   step: 0.05, decimals: 2),
        SliderSpec("Skew", "LookPanel.swift:1191", .developTop, -1...1,
                   step: 0.01, decimals: 2),
        ...
        SliderSpec("Strength", "MaskPanel.swift:327", .developTop, 0...200, step: 1),
        SliderSpec("Exposure", "MaskPanel.swift:2131", .developTop, -4...4,
                   step: 0.05, decimals: 2),
        SliderSpec("Contrast", "MaskPanel.swift:2136", .developTop, -100...100, step: 1),
        SliderSpec("Highlights", "MaskPanel.swift:2140", .developTop, -100...100, step: 1),
        SliderSpec("Shadows", "MaskPanel.swift:2144", .developTop, -100...100, step: 1),
        SliderSpec("Whites", "MaskPanel.swift:2148", .developTop, -100...100, step: 1),
        SliderSpec("Blacks", "MaskPanel.swift:2153", .developTop, -100...100, step: 1),
        SliderSpec("Hue", "MaskPanel.swift:2190", .developTop, -180...180, step: 1),
        SliderSpec("Saturation", "MaskPanel.swift:2194", .developTop, -100...100, step: 1),
        SliderSpec("Vibrance", "MaskPanel.swift:2198", .developTop, -100...100, step: 1),
        SliderSpec("Colorize amount", "MaskPanel.swift:2219", .developTop, 0...100, step: 1),
        SliderSpec("Hue", "MaskPanel.swift:2362", .developTop, -60...60, step: 1),
        SliderSpec("Saturation", "MaskPanel.swift:2364", .developTop, -100...100, step: 1),
        SliderSpec("Luminance", "MaskPanel.swift:2366", .developTop, -100...100, step: 1),
        SliderSpec("Range", "MaskPanel.swift:2368", .developTop, 0...100, step: 1),
        SliderSpec("Variance", "MaskPanel.swift:2370", .developTop, -100...100, step: 1),
        SliderSpec("Texture", "MaskPanel.swift:2387", .developTop, -100...100, step: 1),
        SliderSpec("Clarity", "MaskPanel.swift:2391", .developTop, -100...100, step: 1),
        SliderSpec("Dehaze", "MaskPanel.swift:2394", .developTop, -100...100, step: 1),
        SliderSpec("Sharpness", "MaskPanel.swift:2399", .developTop, -100...100, step: 1),
        SliderSpec("Temp", "MaskPanel.swift:2913", .developTop, 2000...50000, step: 50),
        SliderSpec("Tint", "MaskPanel.swift:2923", .developTop, -150...150, step: 1),
        SliderSpec("Temp", "MaskPanel.swift:2931", .developTop, -100...100, step: 1),
        SliderSpec("Tint", "MaskPanel.swift:2935", .developTop, -100...100, step: 1),

        // Masks — the floating pop-out: what the mask IS. A 272 pt host that never resizes.
        SliderSpec("Contribution", "MaskPanel.swift:1456", .maskComponent, 0...100, step: 1),
        SliderSpec("Feather", "MaskPanel.swift:1526", .maskComponent, 0...100,
                   step: 1, glyph: true),
        SliderSpec("Rotation", "MaskPanel.swift:1534", .maskComponent, -90...90, step: 1),
        SliderSpec("From", "MaskPanel.swift:1547", .maskComponent, -10...4,
                   step: 0.1, decimals: 1),
        SliderSpec("To", "MaskPanel.swift:1552", .maskComponent, -10...4,
                   step: 0.1, decimals: 1),
        SliderSpec("Smooth", "MaskPanel.swift:1570", .maskComponent, 0...100,
                   step: 1, glyph: true),
        SliderSpec("Feather", "MaskPanel.swift:1579", .maskComponent, 0...100,
                   step: 1, glyph: true),
        SliderSpec("Level", "MaskPanel.swift:1594", .maskComponent, 1...5,
                   step: 0.1, decimals: 1, glyph: true),
        SliderSpec("Near", "MaskPanel.swift:1618", .maskComponent, 0...1,
                   step: 0.01, decimals: 2),
        SliderSpec("Far", "MaskPanel.swift:1621", .maskComponent, 0...1,
                   step: 0.01, decimals: 2),
        SliderSpec("Smooth", "MaskPanel.swift:1630", .maskComponent, 0...100, step: 1),
        SliderSpec("Tolerance", "MaskPanel.swift:1643", .maskComponent, 0...100, step: 1),
        SliderSpec("Reach", "MaskPanel.swift:1856", .maskComponent, 1...100, step: 1),
        SliderSpec("Colour", "MaskPanel.swift:1893", .maskComponent, 0...100, step: 1),
        SliderSpec("Brightness", "MaskPanel.swift:1897", .maskComponent,
                   0...100, step: 1),
        SliderSpec("Size", "MaskPanel.swift:1691", .maskDetail, 0.002...0.5,
                   step: 0.002, decimals: 3, glyph: true),
        SliderSpec("Feather", "MaskPanel.swift:1699", .maskDetail, 0...100,
                   step: 1, glyph: true),
        SliderSpec("Flow", "MaskPanel.swift:1705", .maskDetail, 1...100, step: 1, glyph: true),
        SliderSpec("Ceiling", "MaskPanel.swift:1724", .maskDetail, 0...100,
                   step: 1, glyph: true),
        SliderSpec("Steadiness", "MaskPanel.swift:1733", .maskDetail, 0...100, step: 1),
        SliderSpec("Follow", "MaskPanel.swift:2052", .maskDetail, 0...100, step: 1, glyph: true),
        SliderSpec("Expand", "MaskPanel.swift:2064", .maskDetail, -50...50,
                   step: 1, glyph: true),
        SliderSpec("Soften", "MaskPanel.swift:2083", .maskDetail, 0...100, step: 1, glyph: true),
        SliderSpec("Ramp from", "MaskPanel.swift:2092", .maskDetail, 0...100, step: 1),
        SliderSpec("Ramp to", "MaskPanel.swift:2093", .maskDetail, 0...100, step: 1),
        SliderSpec("Ramp shape", "MaskPanel.swift:2094", .maskDetail, 0.2...5,
                   step: 0.05, decimals: 2),
        ...
        SliderSpec("", "LumenControls.swift:1988 (LookPanel.swift:877)", .gradeWheelBar,
                   -1...1, step: 0.01, decimals: 2),
        SliderSpec("", "LumenControls.swift:1988 (MaskPanel.swift:2988)", .maskWheelBar,
                   -1...1, step: 0.01, decimals: 2),

...
enum SliderInventory {
    ...
    static let all: [SliderSpec] = [
        ...
        SliderSpec("Halo Suppression", "DetailPanel.swift:347", .developTop, 0...100, step: 1),
        ...
        SliderSpec("Temp", "MaskPanel.swift:2391", .developTop, 2000...50000, step: 10),
        ...
        SliderSpec("To", "MaskPanel.swift:1244", .maskComponent, -10...4,
                   step: 0.1, decimals: 1),
        SliderSpec("Smoothness", "MaskPanel.swift:1245", .maskComponent, 0...100,
                   step: 1, glyph: true),
        ...
        SliderSpec("Far", "MaskPanel.swift:1276", .maskComponent, 0...1,
                   step: 0.01, decimals: 2),
        SliderSpec("Smoothness", "MaskPanel.swift:1277", .maskComponent, 0...100, step: 1),
        ...
        SliderSpec("Colour tolerance", "MaskPanel.swift:1500", .maskComponent, 0...100, step: 1),
        SliderSpec("Brightness tolerance", "MaskPanel.swift:1501", .maskComponent,
                   0...100, step: 1),
        ...
        SliderSpec("Max strength", "MaskPanel.swift:1350", .maskDetail, 0...100,
                   step: 1, glyph: true),
